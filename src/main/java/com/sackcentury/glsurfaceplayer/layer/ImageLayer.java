 ...
 */
public class ImageLayer implements IDrawLayer {
    ...
    public ImageLayer(Context context, Bitmap bitmap) {
        mBitmap = bitmap;
        mContext = context;

        String vertexShader = TextResourceReader.readTextFileFromResource(mContext, R.raw.default_image_vertex_shader);
        String fragmentShader = TextResourceReader.readTextFileFromResource(mContext, R.raw.default_image_fragment_shader);
