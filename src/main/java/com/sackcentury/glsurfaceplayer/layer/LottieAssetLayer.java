...
import com.sackcentury.utils.DeviceUtil;
...
public class LottieAssetLayer extends LottieLayer {
    ...
    public LottieAssetLayer(Context context, String lottieAssetJson, final String imageAssetFolder) {
        super(context, lottieAssetJson, imageAssetFolder);
        mContext = context;
        ...
        mLottieJson = lottieAssetJson;
        mImageFolder = imageAssetFolder;
    ...
    public void prepare(boolean isRecord) {
        ...
        LottieCompositionFactory.fromAsset(mContext, mLottieJson).addListener(new LottieListener<LottieComposition>() {
            @Override
    ...
    private float getDrawableScale(int intrinsicHeight) {
        int width = DeviceUtil.getScreenWidth(mContext);
        float scale = (350f) / intrinsicHeight;
        Log.e("getDrawableScale: ", "scale - scale: " + scale + " intrinsicHeight: " + intrinsicHeight);
